...
import { getPostsWithLimit } from "./posts/postsController.js";
import { getCommentsByPostId } from "./comments/commentsController.js";
...
async function init() {
  ...
  let posts = await getPostsWithLimit(15);
  posts.map((post) => {
    ...
    //let comments = await getCommentsByPostId(post.id);
